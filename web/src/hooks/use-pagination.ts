// Where: Shared hooks used by dashboard table pagination.
// What: Compute pagination ranges and ellipsis visibility.
// Why: Keeps pagination logic reusable and testable.
...
export function usePagination({
  ...
  // Use calculated pages to decide when ellipsis should show.
